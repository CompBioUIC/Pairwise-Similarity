...
# given a size N, create a geometric distribution of N.
...
# generate the 'not same' distribution based on the geometric distribution created by sizes_of_dist.
...
# generate the 'same' distribution like above.
...
# flip the edges that are false negatives.
...
# flip the edges that are false positives.
...
# calculate values of confusion matrix from the ground truth.
...
# utility function to check if an edge has been flipped.
...
# utility function to check if an edge belongs to 'dont care'.
...
# create a new graph that will be used for generating biconnected components.
...
# find all edges in the biconnected components.
...
# utility function to find false negatives w.r.t. final clustering.
...
# calculate accuracy of final clustering.
