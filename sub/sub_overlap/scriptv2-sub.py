...
def gen_similarity_scores_not_same(sizes, chunks):
    ...
    return sim_scores, np.percentile(sim_scores, 90), np.amin(sim_scores)
...
def assign_same(cluster_list, pairs_SAME, max_not_same, min_not_same):
    sizes, chunks = sizes_of_dist(pairs_SAME)
    sim_scores = gen_similarity_scores_same(sizes, max_not_same, min_not_same)
...
def assign_not_same(global_graph, pair_NOT_SAME):
    ...
    similarity_scores, max_not_same, min_not_same = gen_similarity_scores_not_same(
        sizes, chunks)
    ...
    return global_graph, max_not_same, min_not_same
...
def remove_bcc_edges_from_new_graph(new_graph, bcc_edges_list):
    # I want to isolate edges that are present in new_graph but not in the bc's.
...
def perform_all_steps_10_times(number_of_clusters, nodes_multiplier, cluster_list, global_graph, pairs_SAME, pair_NOT_SAME, threshold):
    ...
    for iteration in tqdm(range(5)):
        ...
        global_graph, max_not_same, min_not_same = assign_not_same(global_graph, pair_NOT_SAME)

        # assign similarity scores to the 'SAME' pairs in the clusters.
        cluster_list = assign_same(cluster_list, pairs_SAME, max_not_same, min_not_same)
    ...
    destination = os.path.join(os.getcwd(), 'sub')
...
def main():
    # cluster_params = [(200, 3), (200, 5), (200, 10), (500, 3),
    #                   (500, 5), (500, 10), (1000, 3), (1000, 5)]

    cluster_params = [(5000, 3)]
